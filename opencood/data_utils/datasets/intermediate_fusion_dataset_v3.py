...
from opencood.data_utils.datasets import basedataset_v3
...
class IntermediateFusionDatasetV3(basedataset_v3.BaseDatasetV3):
    """
    This class is for intermediate fusion where each vehicle transmit the
    deep features to ego.
    """
    def __init__(self, params, visualize, train=True):
        super(IntermediateFusionDatasetV3, self). \
        ...
        self.has_trained = params['model']['args']['has_trained']
    ...
    def __getitem__(self, idx):
        ...
        for cav_id, selected_cav_base in base_data_dict.items():
            ...
            right_processed_features.append(
                selected_cav_processed['right_processed_features'])
        ...
        right_merged_feature_dict = self.merge_features_to_dict(right_processed_features)
        ...
        processed_data_dict['ego'].update(
            {'object_bbx_center': object_bbx_center,
             ...
             'right_processed_lidar': right_merged_feature_dict,
    ...
    def get_item_single_car(self, selected_cav_base, ego_pose):
        ...
        right_transformation_matrix = \
            selected_cav_base['params']['right_transformation_matrix']
        ...
        # filter lidar
        original_lidar_np = selected_cav_base['lidar_np']
        lidar_np = shuffle_points(original_lidar_np)
        # remove points that hit itself
        lidar_np = mask_ego_points(lidar_np)
        # project the lidar to ego space

        right_lidar_np = lidar_np.copy()
        ...
        if self.proj_first:
            lidar_np[:, :3] = \
                box_utils.project_points_by_matrix_torch(lidar_np[:, :3],
                                                         transformation_matrix)
            right_lidar_np[:, :3] = \
                box_utils.project_points_by_matrix_torch(right_lidar_np[:, :3],
                                                         right_transformation_matrix)
        ...
        right_lidar_np = mask_points_by_range(right_lidar_np,
                                        self.params['preprocess'][
                                            'cav_lidar_range'])
        right_processed_lidar = self.pre_processor.preprocess(right_lidar_np)
        # velocity
        ...
        selected_cav_processed.update(
            {'object_bbx_center': object_bbx_center[object_bbx_mask == 1],
             ...
             'right_processed_features': right_processed_lidar,
             'velocity': velocity})
    ...
    def collate_batch_train(self, batch):
        ...
        for i in range(len(batch)):
            ...
            right_processed_lidar_list.append(ego_dict['right_processed_lidar'])
        ...
        right_merged_feature_dict = self.merge_features_to_dict(right_processed_lidar_list)
        right_processed_lidar_torch_dict = \
            self.pre_processor.collate_batch(right_merged_feature_dict)
        ...
        output_dict['ego'].update({'object_bbx_center': object_bbx_center,
                                   ...
                                   'right_processed_lidar': right_processed_lidar_torch_dict,
