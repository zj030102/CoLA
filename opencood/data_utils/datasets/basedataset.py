...
class BaseDataset(Dataset):
    ...
    def __init__(self, params, visualize, train=True):
        ...
        scenario_folders = {
            "/home/lkshpc/wca/data/opv2v/test/2021_08_24_07_45_41"
        }
    ...
    def retrieve_base_data(self, idx, cur_ego_pose_flag=True):
        ...
        for cav_id, cav_content in scenario_database.items():
            ...
            if cav_content['ego']:
                file_path = cav_content[timestamp_key_delay]['lidar']
                ...
                # 拼接
                result = f"{scene_name}_{frame_name}"
                data[cav_id]['index'] = result
